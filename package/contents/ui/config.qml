...
ColumnLayout {
    ...
    Row {
        ...
        QtControls.Label {
            ...
            text: i18nd("plasma_applet_org.kde.plasma.anima", "Positioning:")
        ...
        QtControls.ComboBox {
            ...
            model: [
                        {
                            'label': i18nd("plasma_applet_org.kde.plasma.anima", "Scaled and Cropped"),
                            'fillMode': Image.PreserveAspectCrop
                        },
                        {
                            'label': i18nd("plasma_applet_org.kde.plasma.anima","Scaled"),
                            'fillMode': Image.Stretch
                        },
                        {
                            'label': i18nd("plasma_applet_org.kde.plasma.anima","Scaled, Keep Proportions"),
                            'fillMode': Image.PreserveAspectFit
                        },
                        {
                            'label': i18nd("plasma_applet_org.kde.plasma.anima", "Centered"),
                            'fillMode': Image.Pad
                        },
                        {
                            'label': i18nd("plasma_applet_org.kde.plasma.anima","Tiled"),
                            'fillMode': Image.Tile
                        }
                    ]
    ...
    QtDialogs.ColorDialog {
        ...
        title: i18nd("plasma_applet_org.kde.plasma.anima", "Select Background Color")
    }
    ...
    Row {
        ...
        QtControls.RadioButton {
            id: colorRadioButton
            text: i18nd("plasma_applet_org.kde.plasma.anima", "Solid color")
    ...
    DragDrop.DropArea {
        ...
        onDrop: {
            event.mimeData.urls.forEach(function (url) {
                if (url.indexOf("file://") === 0) {
                    ...
                    if (configDialog.currentWallpaper === "org.kde.plasma.anima") {
        ...
        Loader {
            anchors.fill: parent
            sourceComponent: (configDialog.currentWallpaper == "org.kde.plasma.anima") ? thumbnailsComponent : foldersComponent
        }
    }
    ...
    RowLayout {
        ...
        QtControls.Button {
            visible: (configDialog.currentWallpaper == "org.kde.plasma.anima")
            iconName: "list-add"
            text: i18nd("plasma_applet_org.kde.plasma.anima","Add Image...")
            onClicked: imageWallpaper.showFileDialog();
        }
        QtControls.Button {
            iconName: "get-hot-new-stuff"
            text: i18nd("plasma_applet_org.kde.plasma.anima","Get New Wallpapers...")
